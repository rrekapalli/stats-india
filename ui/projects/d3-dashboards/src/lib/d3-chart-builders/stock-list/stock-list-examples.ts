import { D3StockListChartBuilder, StockListData } from './stock-list-chart-builder';

/**
 * Example usage of D3StockListChartBuilder
 */
export class StockListExamples {
  ...
  static createBasicStockListChart(): any {
    ...
    return D3StockListChartBuilder
      .create()
      .setData(sampleData)
  ...
  static createStockComparisonChart(): any {
    const builder = D3StockListChartBuilder.create();
