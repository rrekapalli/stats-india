-- V3: Spring Batch 5 metadata tables (PostgreSQL).
-- Source: spring-batch-core-5.1.2 schema-postgresql.sql, lowercased to match Postgres
-- identifier folding. tablePrefix in BatchConfiguration is "batch_" (default).
